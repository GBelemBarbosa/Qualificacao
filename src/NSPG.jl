...
@with_kw mutable struct NSPGModel <: AbstractCompositeSolver
    method = :NSPG
...
function NSPG(ProblemModel:: AbstractCompositeModel, SolverModel:: NSPGModel) 
    @unpack_NSPGModel SolverModel
    if isnothing(x₀)
        x₀ = ProblemModel.x₀
    end
...
function NSPGopt(ProblemModel:: AbstractCompositeModel, SolverModel:: NSPGModel)
    @unpack_NSPGModel SolverModel
    if isnothing(x₀)
        x₀ = ProblemModel.x₀
    end
